...
public class _StockMarketYearTest {
	...
	public void totalSold() {
		...
		assertEquals("one sales", new Dollars(3000), year.totalSold());
	...
	public void interestEarned() {
		...
		assertEquals("withdrawals (which pays capital gains tax) don't earn interest", new Dollars(733), year.appreciation());
	}
	...
	public void endingPrincipal() {
		...
		Dollars principalReducedBy = totalWithdrawn.substractToZero(capitalGains);
...
//		assertEquals("ending principal consider withdrawals", new Dollars(3000), year.endingPrincipal());
//		year.withdraw(new Dollars(500));
//		assertEquals("ending principal consider totals multiple withdrawals", new Dollars(3000), year.endingPrincipal());
//		year.withdraw(new Dollars(3000));
//		assertEquals("ending principal never goes below zero", new Dollars(3000), year.endingPrincipal());
//	}
