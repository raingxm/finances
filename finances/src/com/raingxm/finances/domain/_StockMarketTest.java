...
public class _StockMarketTest {
	...
	public void stockMarketContainsMultipleYears() {
		StockMarket account = new StockMarket(STARTING_YEAR, ENDING_YEAR, STARTING_BALANCE, STARTING_PRICIPAL, INTEREST_RATE, CAPITAL_GAINS_RATE, new Dollars(0));
	...
	public void stockMarketWithdrawsAStandardAmountEveryYear() {
		StockMarket account = new StockMarket(STARTING_YEAR, ENDING_YEAR, STARTING_BALANCE, STARTING_PRICIPAL, INTEREST_RATE, CAPITAL_GAINS_RATE, new Dollars(10));
	...
	public void capitalGainsTaxCalculationWorksTheSameWayAsSpreadsheet() {
		StockMarket account = new StockMarket(STARTING_YEAR, ENDING_YEAR, STARTING_BALANCE, STARTING_PRICIPAL, INTEREST_RATE, CAPITAL_GAINS_RATE, new Dollars(715));
